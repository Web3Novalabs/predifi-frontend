                ...
                <div className="w-full lg:w-1/2 order-2 lg:order-1">
                    <div className="max-w-lg mx-auto lg:mx-0">
                        ...
                        <p className="text-gray-400 text-base md:text-lg mb-8">
                            The page you’re looking for doesn’t exist. Here’s what you can do:
                        </p>
                        <Link
                            href="/"
                            className="inline-flex items-center px-6 py-3 text-base font-medium text-[#122638] bg-[#37B7C3] hover:bg-gray-100 rounded-md transition-colors duration-200 hover:bg-[#2aa3b1] hover:scale-105 transition-all duration-300"
                        >
                            Back to homepage
                        </Link>
                    </div>
